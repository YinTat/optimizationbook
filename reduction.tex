...
from the initial error. With this view, we can think of the required
numbers of iterations for Lipschitz convex functions, strongly convex
functions and smooth functions as exactly $\frac{1}{\epsilon^{2}_{\mathrm{relative}}}$,

...
from the initial error. With this view, we can think the numbers of
iterations required for Lipschitz convex functions, strongly convex
functions and smooth functions are exactly $\frac{1}{\epsilon^{2}_{\mathrm{relative}}}$
...
The cost per iteration sometimes can be misleading also. Each iteration

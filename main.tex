...
(book in progress; citations being improved)}
...
\input{preliminaries.tex}\input{examples.tex} 
...
\input{cutting_plane.tex}\input{geometric_descent.tex}\input{lower_bound.tex}

\chapter{Reduction}

\input{equivalence.tex} \input{duality.tex}

\chapter{Geometrization}

\input{frank_wolfe.tex}\input{newton_method.tex}\input{interior_point_method.tex}\input{reduction.tex}

\chapter{Sparsification}

\input{subspace_embedding.tex}\input{leverage_score_sampling.tex}\input{stochastic_gradient_descent.tex}

\chapter{Acceleration}

\input{chebyshev.tex}\input{conjugate_gradient.tex}\input{accelerated_gradient_descent.tex}

\part{Sampling}

\chapter{Gradient-based Sampling}

\input{langevin_dynamics.tex}

\chapter{Elimination and Reduction\label{chap:Elimination-and-Reduction}}

\input{cutting_plane_volume.tex}\input{opt_from_mem.tex}

\chapter{Geometrization }

\input{ball_walk.tex}\input{har_dikin.tex}\input{RHMC.tex}

\chapter{Annealing \label{chap:Annealing} }

\input{annealing.tex}\input{annealing_volume.tex}

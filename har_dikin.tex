...
\]
We will prove the opposite inequality to establish a contradiction.Moreover,
without loss of generality, we can assume as in the proof of Euclidean
isoperimetry that $Z_{1},Z_{2}$are single intervals, $Z_{1}=[0,u]$
and $Z_{2}=[v,1].$ Rewriting, it suffices to show that 
\[
...
that for any $u\in S_{1},$$v\in S_{2}$, and any $x$ on the chord
through $u$ and $v$, we have 
\[
